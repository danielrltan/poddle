...
| `serve-prompt` | + `.toast.on` | **Your serve!** (only during play). Other toasts: **Re-centered** · **Line up with the ball, then swing** · **Swing at the ball to serve** · **Body: step to move, tilt the AirPod to walk** · **Auto: the game runs, you swing** · **Club Bot** (during play only) · **Can’t add a bot with two players in** · **Range: step 25% of the view to reach the sideline** · **Range: turn 75° to reach the sideline** · **Saved address didn’t answer. Using this Mac.** · **Weak connection. Smoothing it out.** · **AirPod signal lost** · **Reconnecting to the game** (`hud-airpod-lost`) · rooms: **Opponent left** · **Press Q again to leave** · **Link copied** · **Room closed** · **No answer. Try again.** No toast on a miss. |
